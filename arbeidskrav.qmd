...
Modell 3 ser igjen litt bedre ut enn modell 1 og modell 2, men heteroskedastisitet kan fortsatt være et problem.
...
@fig-6 viser resultatene fra en simultantest på tids-dummiene i modell 1.
...
#| echo: false
#| label: fig-6
#| fig-cap: Simultan test på tids-dummiene for Modell 1
...
@fig-7 viser resultatene fra en simultantest på tids-dummiene i modell 2.
...
#| echo: false
#| label: fig-7
#| fig-cap: Simultan test på tids-dummiene for Modell 2
...
@fig-8 viser resultatene fra en simultantest på tids-dummiene i modell 3.
...
#| echo: false
#| label: fig-8
#| fig-cap: Simultan test på tids-dummiene for Modell 3
...
Vi skal se på valg av modell vha.
metodene til både Anselin (1988) og LeSage (n.d.).
...
Vi har formulert modellen vi ønsker å bruke og har kjørt den som en OLS-modell.
Vi skal se nærmere på residualene i denne modellen for å avgjøre om vi har uforklarte spatial effects i residualene.
...
Resultatene fra Moran’s I-testen indikerer at det er en signifikant romlig autokorrelasjon i residualene fra regresjonsmodellen.
For Moran’s I med lw3 fikk vi en observert Moran I-verdi på 0.442 med en standard deviasjon på 25.384 og en p-verdi på mindre enn 2.2e-16.
For Moran’s I med lw10 var den observerte Moran I-verdien 0.390 med en standard deviasjon på 40.616 og en p-verdi på mindre enn 2.2e-16.
...
Moran’s I-verdiene for både lw3 og lw10 er positive og signifikante, noe som indikerer at residualene fra modellen er spatialt korrelerte, altså at det er en tendens til at områder med like restverdier (høye eller lave) grupperer seg sammen i rommet.
Dette betyr at det er spatial avhengighet som modellen ikke har klart å fange opp.
Den romlige korrelasjonen er noe sterkere for lw3 (nærmeste tre naboer) sammenlignet med lw10 (nærmeste ti naboer), noe som tyder på at den spatial korrelasjonen kan være mer lokal i naturen.

Dette funnet indikerer at modellen ikke tilstrekkelig fanger opp alle de romlige forholdene som påvirker boligprisene.
For å håndtere denne romlige autokorrelasjonen bør det vurderes å bruke romlige regresjonsmodeller, som Spatial Lag Model (SLM) eller Spatial Error Model (SEM), som tar hensyn til den romlige avhengigheten.
...
Moran-plottene for OLS-residualene (k = 3 og k = 10) gir en visuell representasjon av romlig autokorrelasjon i modellens residualer.
...
Moran-plottet for k = 3 indikerer en positiv romlig autokorrelasjon.
...
Moran-plottet for k = 10 viser en lignende trend som for k = 3, men sammenhengen ser noe svakere ut.
...
Bruk Anselin ([1988](https://msb205.netlify.app/assignment/kc_h24/assignment_text_24#ref-Anselin1988)) sin teknikk med Lagrange Multiplikator test vha.
...
### 6.3.4 Testing og sammenligning av de ulike modellene
...
Vi skal se nærmere på residualene fra de ulike modellene for å illustrere hvor godt hver modell fjerner «spatial effects» fra residualene.
Vi ser kun på modellene for k=10 (10 nærmeste naboer).
