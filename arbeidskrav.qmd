...
Her blir @anselin1988 sin teknikk med Lagrange Multiplikator test brukt og videre diskuteres hvilken modell (SAR, SEM eller lm (OLS)) som synes å være den beste.
...
Kommentar: **OLS-modellen**: Basert på de svært signifikante p-verdiene fra alle testene, kan vi konkludere med at OLS-modellen ikke klarer å håndtere romlige avhengigheter i dataene på en tilfredsstillende måte.
...
```{r}
# Se resultatene fra SAR-modellen for k = 3
